...
def split(xml,dtd,output_dir):
    ...
    source = xml
    dtd = etree.DTD(file=dtd)  # read DTD

    directory_list = ["/articles","/books","/incollections","/inproceedings","/mastersthesis","/phdthesis","/proceedings","/authors","/editors"]
    ...
    author_orcid_xml_name = output_dir+"/authors/author_orcid"
    editor_orcid_xml_name = output_dir+"/editors/editor_orcid"
    ...
    article_xml_name = output_dir+"/articles/article"

    book_xml_name = output_dir+"/books/book"

    phdthesis_xml_name = output_dir+"/phdthesis/phdthesis"

    inproceedings_xml_name = output_dir+"/inproceedings/inproceedings"

    proceedings_xml_name = output_dir+"/proceedings/proceedings"

    incollection_xml_name = output_dir+"/incollections/incollection"

    mastersthesis_xml_name = output_dir+"/mastersthesis/mastersthesis"
    ...
    context = etree.iterparse(source, load_dtd=True, events = ("start", "end"))
    ...
    #for event, element in etree.iterparse(source, load_dtd=True):
        ...
        if(element.tag == "article" and event == "end"):
        ...
        if(element.tag == "phdthesis" and event == "end"):
            if str(element.attrib.get('mdate')) != "None" and str(element.attrib.get('key')) != "None":
        ...
        if(element.tag == "inproceedings" and event == "end"):
            if str(element.attrib.get('mdate')) != "None" and str(element.attrib.get('key')) != "None":
        ...
        if(element.tag == "proceedings" and event == "end"):
            if str(element.attrib.get('mdate')) != "None" and str(element.attrib.get('key')) != "None":
        ...
        if(element.tag == "book" and event == "end"):
            if str(element.attrib.get('mdate')) != "None" and str(element.attrib.get('key')) != "None":
        ...
        if(element.tag == "incollection" and event == "end"):
            if str(element.attrib.get('mdate')) != "None" and str(element.attrib.get('key')) != "None":
        ...
        if(element.tag == "mastersthesis" and event == "end"):
            if str(element.attrib.get('mdate')) != "None" and str(element.attrib.get('key')) != "None":
